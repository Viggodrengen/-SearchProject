...
echo
echo "Demo commands:"
echo "  BASE_URL=$API_URL ITERATIONS=100 REDIS_DOWN_REQUESTS=3 scripts/k8s-demo-story.sh"
echo "  BASE_URL=$API_URL LOW_REPLICAS=1 HIGH_REPLICAS=10 REQUESTS=200 CONCURRENCY=30 scripts/k8s-scale-performance-test.sh"
