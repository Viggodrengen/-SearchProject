# AI Extract: Opgavesæt M7.03 - Intro til Minikube.pdf

- Kilde: `Opgavesæt M7.03 - Intro til Minikube.pdf`
- Type: `pdf`
...
 Opgave A - Installation af Minikube
  ...
  2. Fra en terminal, start et minikube cluster på din maskine kør kommandoen: minikube start .
  3. Tjek at dit cluster er oppe at køre med kubectl get po -A




 Opgave B - minikube Dashboard
Fra terminalen, start minikube's dashboard med kommandoen minikube dashboard . Dette åbner
...
Find trin 4 (Deploy application) på minikubes Get Started side. Følg instrukserne under
"Service"-fanen (vi gemmer LoadBalancer & Ingress eksemplerne til senere!).

Når du har afprøvet echo-serveren , så tilgå dashboard'et igen, og find den oprettede pod og
service og undersøg den tilgængelige information.
   ...
    Information
        ...
        kubectl create deployment ... og kubectl expose deployment ... ?
...
 Opgave D - Deployment med YAML-fil
 ...
 1. Start med at oprette en ny tom folder til den nye deployment-fil.
 2. I folderen, opret en ny fil, kald den f.eks. deployment.yaml og indsæt teksten herunder:
...
                                      Opgavesæt M7.03 - Intro til Minikube
      ...
      15              containers:
      16                 - name: hello-world
      17                     image: us-docker.pkg.dev/google-samples/containers/gke/hello-app:2.0
      18                     ports:
      19                      - containerPort: 8080
      20                         protocol: TCP

 3. Gennemgå filens indhold og dobbelttjek at indenteringen er korrekt!
 4. Åben en terminal i folderen
 5. Opret et nyt deployment med kommandoen kubectl apply -f deployment.yaml
 6. Tjek at operationen gik godt, med: kubectl get deployments hello-world -- som bør vise at
   der er 2 Pods (under READY).
 7. Vis også en mere detaljeret beskrivelse af operationen med
    kubectl describe deployments hello-world
 8. Lav nu en K8s service som samler de 2 Pods fra forgående operation med flg. kommando:

       1
       2     kubectl expose deployment hello-world --type=NodePort --name=hello-world-service
       3


 9. Vis lidt info omkring den nye service: kubectl get services hello-world-service
10. Til sidst mangler vi at lave en forbindelse imellem servicen og vores egen maskine, således at
   vi kan tilgå den i en browser. Dette klares af minikube med kommandoen:
    minikube service hello-world-service --url . Du får en url tilbage i svaret fra kommandoen,
   som du kan tilgå med en browser eller curl -kommandoen.
...
følgende bash-kommando:
    ...
    1      for i in {1..20}; do curl -s <url fra opgave D.10> | grep Hostname; done
...
Til sidst fjerner vi de oprettede Kubernetes objekter igen. Først servicen efterfulgt af deployment:
    ...
    1     kubectl delete -n default service hello-world-service
...
![ai_opgavest-m7-03-intro-til-minikube__page_001.png](ai_opgavest-m7-03-intro-til-minikube__page_001.png)
![ai_opgavest-m7-03-intro-til-minikube__page_002.png](ai_opgavest-m7-03-intro-til-minikube__page_002.png)
![ai_opgavest-m7-03-intro-til-minikube__page_003.png](ai_opgavest-m7-03-intro-til-minikube__page_003.png)
![ai_opgavest-m7-03-intro-til-minikube__page_004.png](ai_opgavest-m7-03-intro-til-minikube__page_004.png)
