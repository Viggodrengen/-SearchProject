...
**Gruppe:** Victor Rodam & Gustav Anderson  
**Projekt:** Videreudvikling af eksisterende SearchProject  
**Titel:** SearchProject v2: caching, performance/failover og database-skalering  
**Github link:** https://github.com/Viggodrengen/-SearchProject
...
Der udarbejdes en konkret og begrundet anvisning for dataskalering på z-aksen, inklusive en realistisk migrations retning.
...
- Testrapport med resultater fra performance-, latency- og failover-scenarier
